...
#import "TBBadgeView.h"

@implementation TBBadgeView
{
...
- (void)setup
{
    ...
    _horizontalAlignment = TBBadgeViewHorizontalAlignmentRight;
    _verticalAlignment = TBBadgeViewVerticalAlignmentTop;
...
- (void)autoSetBadgeFrame
{
    ...
    if (_horizontalAlignment == TBBadgeViewHorizontalAlignmentLeft) {
        frame.origin.x = 0 - (frame.size.width / 2) + _alignmentShift.width;
    } else if (_horizontalAlignment == TBBadgeViewHorizontalAlignmentCenter) {
        frame.origin.x = (self.superview.bounds.size.width / 2) - (frame.size.width / 2) + _alignmentShift.width;
    } else if (_horizontalAlignment == TBBadgeViewHorizontalAlignmentRight) {
    ...
    if (_verticalAlignment == TBBadgeViewVerticalAlignmentTop) {
        frame.origin.y = 0 - (frame.size.height / 2) + _alignmentShift.height;
    } else if (_verticalAlignment == TBBadgeViewVerticalAlignmentMiddle) {
        frame.origin.y = (self.superview.bounds.size.height / 2) - (frame.size.height / 2.0) + _alignmentShift.height;
    } else if (_verticalAlignment == TBBadgeViewVerticalAlignmentBottom) {
...
- (void)setHorizontalAlignment:(TBBadgeViewHorizontalAlignment)horizontalAlignment
{
    _horizontalAlignment = horizontalAlignment;
    [self autoSetBadgeFrame];
}

- (void)setVerticalAlignment:(TBBadgeViewVerticalAlignment)verticalAlignment
{
