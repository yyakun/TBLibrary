...
@interface TBScrollViewHorizontalItem ()<UIScrollViewDelegate>
...
/**  */
@property (weak, nonatomic) id<TBScrollViewHorizontalItemDelegate> delegate;
...
/** 排布方向 */
@property (assign, nonatomic) TBDistributionDirection distributionDirection;

@end

@implementation TBScrollViewHorizontalItem
...
- (void)initValue {
    ...
    _lineSpace = 10;
    _columnSpace = 10;
    _distributionDirection = TBDistributionDirectionHorizontal;
...
//    self.scrollView = nil;
    ...
    switch (self.distributionDirection) {
        case TBDistributionDirectionHorizontal:
            ...
            break;
        case TBDistributionDirectionVertical:
